          ...
          ?.map((todo) => {
            return (
              <>
                <div
                  key={todo._id}
                  className={`p-2 ${todo?.isCompleted? "hover:bg-green-100" :"hover:bg-yellow-100"} text-sm ${todo?.isCompleted? "text-green-600" :"text-yellow-600"} rounded-xl flex justify-between place-items-center`}
                >
                  <h2>{todo.desc}</h2>
                  ...
                  <div className="m-0 flex justify-between place-items-center gap-x-2">
                    ...
                    {
                      todo?.isCompleted == true ? null : ( <button
